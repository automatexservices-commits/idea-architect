  ...
  head: () => ({
    meta: [
      { title: "PLANNR Login | Access Your Planner" },
      {
        name: "description",
        content:
          "Sign in to PLANNR to manage classes, tasks, and goals from your personal planning dashboard.",
      },
...
function WelcomePage() {
  ...
  const { mode: initialMode } = useSearch({ from: "/welcome" });
      ...
      <aside className="relative hidden lg:flex flex-col justify-between overflow-hidden p-10 xl:p-14">
        ...
        <div className="relative max-w-md">
          ...
          <p className="mt-5 text-base text-muted-foreground leading-relaxed">
            One sentence in. A complete project package out - PRD, architecture, API spec, design
        ...
        <div className="w-full max-w-[575px] animate-fade-up">
          ...
          <div className="relative rounded-[2rem] border border-white/70 bg-white/88 shadow-[0_30px_80px_-30px_rgba(0,0,0,0.22)] backdrop-blur-2xl px-6 py-7 sm:px-7 sm:py-8 overflow-hidden">
            ...
            <div className="pointer-events-none absolute inset-0 opacity-70">
              <div
                className="particle-dot left-[8%] top-[14%]"
                style={{ animationDuration: "4.8s" }}
              />
              <div
                className="particle-dot left-[70%] top-[11%]"
                style={{ animationDelay: "0.6s", animationDuration: "5.2s" }}
              />
              <div
                className="particle-dot left-[92%] top-[28%]"
                style={{ animationDelay: "0.2s", animationDuration: "4.4s" }}
              />
              <div
                className="particle-dot left-[48%] top-[79%]"
                style={{ animationDelay: "1s", animationDuration: "5.8s" }}
              />
              <div
                className="particle-dot left-[86%] top-[92%]"
                style={{ animationDelay: "0.8s", animationDuration: "4.9s" }}
              />
              <div
                className="particle-dot left-[16%] top-[64%]"
                style={{ animationDelay: "1.4s", animationDuration: "5.6s" }}
              />
            </div>
